# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/TuneinRadio/bootlogo.py
...
class bootlogo(Screen):
    ...
    def __init__(self, session):
        ...
        self.plugin_name = 'TuneinRadio'
        self.systemlock = ''
        self.server_updatefile = 'http://tunisia-dreambox.info/TSplugins/TuneinRadio/TuneinRadio_updates.txt'
        self.server_softpath = 'http://tunisia-dreambox.info/TSplugins/TuneinRadio'
        self.timer1 = eTimer
    ...
    def disappear(self):
        ...
        if True:
            from .startmenu import StartMenuscrn
            self.session.openWithCallback(self.close, StartMenuscrn, self.updateinfo, self.plugin_name, self.back_close, self.active)
        return